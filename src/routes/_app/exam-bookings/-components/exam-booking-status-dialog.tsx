...
import { EXAM_BOOKING_STATUSES } from '../-types'

interface ExamBookingStatusDialogProps {
  isOpen: boolean
...
export function ExamBookingStatusDialog({
  isOpen,
  onOpenChange,
  currentStatus,
  onConfirm,
  isPending,
}: ExamBookingStatusDialogProps) {
      ...
      <AlertDialogContent>
        ...
        <div className="py-4">
          <Select value={newStatus} onValueChange={setNewStatus}>
            ...
            <SelectContent>
              {EXAM_BOOKING_STATUSES.map((status) => (
